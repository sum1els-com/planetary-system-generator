...
function calculate(lum) {
    let luminosity = (typeof lum == "undefined" || String(lum).trim() == "") ? 1 : lum;
    let naPos = settings.seriesMax;
    let redPos = 0;
    let orbitalDistance = {
        roll: {},
        series: [],
    ...
    for(let i = 2; i < settings.seriesMax; i++) {
...
const orbitalDistanceGenerator = {
    calculate: calculate,
    calculateMultiStar: calculateMultiStar,
    settings: settings
};

export default orbitalDistanceGenerator;
