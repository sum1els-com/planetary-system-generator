import moonGenerator from './moon-generator.js';
    ...
    tablePromise.done(function(data){
        data.forEach(function(element) {
            if(element["red_zone"] > 0) {
                for(let i=0; i<element["red_zone"]; i++) {
    ...
    tablePromise.done(function(data){
        data.forEach(function(element) {
            if(element["yellow_zone"] > 0) {
                for(let i=0; i<element["yellow_zone"]; i++) {
    ...
    tablePromise.done(function(data){
        data.forEach(function(element) {
            if(element["green_zone"] > 0) {
                for(let i=0; i<element["green_zone"]; i++) {
    ...
    tablePromise.done(function(data){
        data.forEach(function(element) {
            if(element["blue_zone"] > 0) {
                for(let i=0; i<element["blue_zone"]; i++) {
    ...
    tablePromise.done(function(data){
        data.forEach(function(element) {
            if(element["black_zone"] > 0) {
                for(let i=0; i<element["black_zone"]; i++) {
